...
class ElectricCar(Car):
    def __init__(self,car_type,brand, model,year,kilometrage,kilowatts, range_km):
        super().__init__(car_type,brand,model,year,kilometrage)
...
class CombustionCar(Car):
    def __init__(self,car_type,brand,model,year,kilometrage,aspiration,engine_capacity):
        super().__init__(car_type,brand, model,year,kilometrage)
